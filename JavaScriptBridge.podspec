Pod::Spec.new do |s|
  ...
  #s.frameworks            = "JavaScriptCore"
   ...
   s.subspec 'Core' do |core|
    ...
    core.source_files  = ['Classes/*.{h,m}', "Classes/Private/JSBScriptingSupport+Private.{h,m}"]
    core.private_header_files  = "Classes/Private/JSBScriptingSupport+Private.{h,m}"
